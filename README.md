...
[![npm](https://img.shields.io/npm/v/@devtea2028/dolorem-quidem-ad-culpa.svg)](https://www.npmjs.com/package/@devtea2028/dolorem-quidem-ad-culpa)
...
```ts
import type * as CSS from '@devtea2028/dolorem-quidem-ad-culpa';
...
```js
// @flow strict
import * as CSS from '@devtea2028/dolorem-quidem-ad-culpa';
...
```sh
$ npm install @devtea2028/dolorem-quidem-ad-culpa
```
...
2.  **Have a look in [issues](https://github.com/devtea2028/dolorem-quidem-ad-culpa/issues) to see if an issue already has been filed. If not, create a new one.** To help us out, please refer to any information you have found.
3.  Fix the issue locally with **TypeScript** (Flow further down):
    ...
    - The recommended way is to use **module augmentation**. Here's a few examples:
      ...
      declare module '@devtea2028/dolorem-quidem-ad-culpa' {
